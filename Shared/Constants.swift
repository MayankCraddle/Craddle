...
//"https://craddle.com:8443"
//"https://frontsaharago.com:8443"
...
let IMAGE_URL = ""
let GOOGLE_API_KEY =  "AIzaSyC2-JbZGb77evJ--W8QgbJvBy7lIWOzS00"
...
var categoryId = ""
var isCategoryEdit = ""
var selectedCountryColor = UIColor()
var CountryList = [Select_Country_List_Struct]()
var globalCartProducts = [cartProductListStruct]()
var globalCartItemsArr: NSMutableArray = NSMutableArray()
var globalDbCartItemsArr: NSMutableArray = NSMutableArray()
var defaultAddressArr = [address_Struct]()
var countryColor = UIColor()
var categoriesList = [categoryListStruct]()
var parentCategoriesList = [categoryListStruct]()
var categoriesListCopy = [categoryListStruct]()
var subCategoriesList = [categoryListStruct]()
var lastCategoriesList = [categoryListStruct]()
var mediaProductsList = [mediaContentListStruct]()
...
struct PROJECT_URL {
    ...
    static let USER_SOCIAL_LOGIN = "/api/v1/user/loginWithSocialMedia"
    ...
    static let GET_NOTIFICATIONS = "/api/v1/user/getNotifications"
    ...
    static let GET_NEW_PRODUCTS_LIST = "/api/v1/user/getNewProducts/"
    static let GET_SAMPLE_PRODUCTS_LIST = "/api/v1/user/getRequestForSampleProducts/"
    static let GET_DISCOUNTED_LIST = "/api/v1/user/getDiscountProducts/"
    static let PROCESS_ORDER = "/api/v1/user/getDiscountProducts/"
    static let GET_ALL_CONTENT_SECTION = "/api/v1/user/getContentWithSections?"
    static let GET_NEW_PRODUCTS_BY_COUNTRY = "/api/v1/user/getNewProductsByCountry?country=Nigeria"
    static let GET_ONSALE_PRODUCTS_BY_COUNTRY = "/api/v1/user/getOnSaleByCountry?country=Nigeria"
    static let GET_TOP_DEALS_PRODUCTS_BY_COUNTRY = "/api/v1/user/getTopDealsByCountry?country=Nigeria"
    static let GET_CATEGORIES_WITH_SUBCATEGORIES = "/api/v1/saharaGo/getCategoriesWithSubCategory"
    static let VERIFY_PAYMENT = "/api/v1/payment/verifyPayment?"
    static let ORDER_TRACKING_STATUS_API = "/api/v1/user/trackOrder/"
    static let GET_SHIPPING_RATE_API = "/api/v1/user/getShipmentRate"
    static let GET_ORDER_DETAILS = "/api/v1/user/getOrderDetails/"
    static let CANCEL_ORDER = "/api/v1/user/cancelOrder"
    static let CHANGE_ACCOUNT_STATUS = "/api/v1/user/changeUserAccountStatus"
    static let GET_MEDIA_CATEGORY_LIST = "/api/v1/user/getSectionList?country="
    static let GET_MULTIMEDIA_PRODUCTS = "/api/v1/user/getMultimediaProducts/"
...
struct USER_DEFAULTS_KEYS {
    ...
    static let IS_SOCIAL_MEDIA_LOGGED_IN = "socialMediaLoggedIn"
    ...
    static let SEARCH_IS_FROM = "searchIsFrom"
...
func getFormattedDateStr1(dateStr:String, dateFormat: String) -> String
{
    let formatter = DateFormatter()
    //    formatter.dateFormat = "dd/MM/yyyy"
    formatter.dateFormat = "yyyy-MM-dd HH:mm:ss"
