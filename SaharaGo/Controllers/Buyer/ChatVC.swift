...
//  SaharaGo
//
//  Created by ChawTech Solutions on 19/10/22.
//
...
class ChatVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.chatTableView.makeRoundCorner(20)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if self.isFromEnquiry {
            self.messageTxtView.text = "Hey, I would like to inquire about \(self.productName)"
        }
        getConversationId()
    }
...
//            }
//        }
        sender.sendPushNotification(to: self.fcmKey , title: "New Message from \(name ?? "")", body: message,email : "", queryID : "", image: image)
    }
...
//        let queryI = messages[indexPath.row].queryId
        if message.fromID == senderId{
            ...
            cell.layoutIfNeeded()
//            self.chatTableView.reloadRows(at: [indexPath], with: .top)
